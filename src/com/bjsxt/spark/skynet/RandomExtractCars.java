	...
	private static JavaPairRDD<String, String> getCarTrack(
		...
		JavaPairRDD<String, String> carTrackRDD = groupByCar.mapToPair(
			...
			public Tuple2<String, String> call(Tuple2<String, Iterable<Row>> tuple) throws Exception {
				...
				return new Tuple2<String, String>(car, Constants.FIELD_DATE+
						"="+date+"|"+Constants.FIELD_CAR_TRACK+"="+carTrack.substring(1));
			}
		});
	...
	private static JavaPairRDD<String, Row> randomExtractCarInfo(
		...
		JavaPairRDD<String, String> dateHourCar2DetailRDD = cameraRDD.mapToPair(
			...
			public Tuple2<String, String> call(Row row) throws Exception {
				...
				String dateHour = DateUtils.getDateHour(actionTime);//2018-01-01_08
		...
		JavaPairRDD<String, Row> randomExtractCar2DetailRDD =extractCarRDD.distinct().join(car2DetailRDD).mapPartitionsToPair(
			...
			public Iterable<Tuple2<String, Row>> call(Iterator<Tuple2<String, Tuple2<String, Row>>> iterator) throws Exception {
				...
				while(iterator.hasNext()){
					...
					Row row = tuple._2._2;
					String car = tuple._1;
					RandomExtractMonitorDetail m = new RandomExtractMonitorDetail(
