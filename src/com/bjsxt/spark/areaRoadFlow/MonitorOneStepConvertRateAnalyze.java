...
//		}
	 ...
	 */
	private static Map<String, Double> computeRoadSplitConvertRate(String roadFlow, Map<String, Long> splitCount) {
		//0001，0002，0003，0004，0005
...
//		List<String> roadFlowList = Arrays.asList(split);
		...
		for (int i = 0; i < split.length; i++) {
			tmpRoadFlow += "," + split[i];   
			Long count = splitCount.get(tmpRoadFlow.substring(1));
			if(count != 0L){
				/**
				 * 1_2
