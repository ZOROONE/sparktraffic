...
public class AreaTop3RoadFlowAnalyze {
	public static void main(String[] args) {
		SparkConf conf = new SparkConf().setAppName("AreaTop3ProductSpark").set("spark.sql.shuffle.partitions", "1");
		...
		Task task = taskDAO.findTaskById(taskid);
		 ...
		 /*---------------------   4  提取字段monitor_id等，注册tmp_car_flow_basic -------------------------*/
		 /**
		  * 补全区域信息    添加区域名称
		 ...
		 /*---------------------   5  按area_name, road_id分组，调用udaf函数，统计monitor_infos ------------------*/
		 /**
		  * 统计各个区域各个路段车流量的临时表
		  * 
